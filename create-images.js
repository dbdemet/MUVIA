...
// Minimal JPEG file (small valid JPEG)
...
// Minimal PNG file (1x1 green pixel)
...
fs.writeFileSync(path.join(dir, 'campus.jpg'), jpegBuffer);
fs.writeFileSync(path.join(dir, 'logo.png'), pngBuffer);

console.log('✓ Placeholder images created');
console.log('✓ campus.jpg - JPEG background');
console.log('✓ logo.png - PNG logo');
